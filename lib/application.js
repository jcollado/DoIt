...
function ListModel(app, data) {
  ...
  /**
   * Enable hover property
   *
   * This is useful to show list actions when mouse is over the list
   */
  ...
  /**
   * Disable hover property
   *
   * This is useful to hide list actions when mouse is away from the list
   */
