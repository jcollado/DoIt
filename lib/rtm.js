...
function RTM(apiKey, sharedSecret) {
  ...
  this.lists = {
     ...
     * @param {string} name - Name for the new list to be added
     * @param {function} success - Callback to be executed on successful response
     * @param {function} failure - Callback to be executed on failed response
     */
    'add': function add(authToken, timeline, name, success, failure) {
      var params = {
     ...
     * @param {function} failure - Callback to be executed on failed response
     */
    'remove': function remove(authToken, timeline, listId, success, failure) {
      var params = {
     ...
     * @param {string} name - New name to be used for the task
     * @param {function} success - Callback to be executed on successful response
     * @param {function} failure - Callback to be executed on failed response
     */
    'setName': function setName(authToken, timeline, listId, name, success, failure) {
      var params = {
  ...
  this.tasks = {
     ...
     * @param {function} failure - Callback to be executed on failed response
     */
    'setName': function setName(authToken, timeline, listId, taskSeriesId, taskId, name, success, failure) {
      var params = {
     ...
     * @param {string} authToken - Authentication token obtained from the API
     * @param {string} timeline - Timeline as obtained through the API
     * @param {string} fromListId - ID for the list where the task is now
     * @param {string} toListId - ID for the list where the task is to be moved to
     * @param {string} taskSeriesId - ID for the task series that contains a task
     * @param {string} taskId - ID for the task to delete
     * @param {function} success - Callback to be executed on successful response
     * @param {function} failure - Callback to be executed on failed response
     */
    'moveTo': function(authToken, timeline, fromListId, toListId, taskSeriesId, taskId, success, failure) {
      var params = {
